...
Considering the previous results, researchers might consider planning a replicability study to obtain more reliable results. The function `prospective()` can be used to compute the sample size needed to obtain a required level of power (e.g., power = 80%).
