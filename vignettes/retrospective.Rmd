...
Arguments complete description is provided in the function help page `?retrospective`. In the following sections, instead, different function applications are presented. For further details about design analysis see @altoeEnhancingStatisticalInference2020 and @bertoldoDesigningStudiesEvaluating2020.
