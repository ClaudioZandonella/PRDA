...
cohen_loop <- function(sample_n1, effect_target, sample_n2, test_method, alternative, mu, B) {
    .Call(`_PRDAbeta_cohen_loop`, sample_n1, effect_target, sample_n2, test_method, alternative, mu, B)
}
